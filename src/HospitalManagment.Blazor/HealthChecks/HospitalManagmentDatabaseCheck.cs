...
public class HospitalManagmentDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public HospitalManagmentDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
