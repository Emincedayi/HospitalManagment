...
public class HospitalManagmentDbContext :
    AbpDbContext<HospitalManagmentDbContext>,
    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(HospitalManagmentConsts.DbTablePrefix + "YourEntities", HospitalManagmentConsts.DbSchema);
