...
public class HospitalManagmentDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        HospitalManagmentGlobalFeatureConfigurator.Configure();
        HospitalManagmentModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<HospitalManagmentDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<HospitalManagmentResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/HospitalManagment");

            options.DefaultResourceType = typeof(HospitalManagmentResource);
        ...
        {
            options.MapCodeNamespace("HospitalManagment", typeof(HospitalManagmentResource));
        });
    }
}
